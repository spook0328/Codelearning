...
import { CommandInstance, CommandHandler, CommandBuilderDefinition, CommandBuilder, CommandHandlerCallback, FinishCommandHandler } from 'yargs/build/lib/command';
...
import { YError } from 'yargs/build/lib/yerror';
import { UsageInstance, FailureFunction } from 'yargs/build/lib/usage';
import { CompletionFunction } from 'yargs/build/lib/completion';
import { ValidationInstance, KeyOrPos } from 'yargs/build/lib/validation';
import { Y18N } from 'y18n';
import { MiddlewareCallback, Middleware } from 'yargs/build/lib/middleware';
